...
@AllArgsConstructor
public enum CustomerExceptionType implements BaseExceptionType {
    NOT_FOUND_Customer(600, HttpStatus.OK, "등록된 정보가 없습니다. 다시 시도해주시거나 회원 가입 후 진행해주세요."),
    WRONG_JOIN_Customer(601, HttpStatus.OK, "가입에 실패하였습니다. 다시 시도해주세요."),
