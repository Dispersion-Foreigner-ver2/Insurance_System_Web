...
public class CustomerService {
    ...
    public void join(PostCustomerJoinDto postCustomerJoinDto) {
        ...
        customer.setAddress(postCustomerJoinDto.getAddress());
        customer.setPhoneNumber(postCustomerJoinDto.getPhoneNum());
        customer.setEmail(postCustomerJoinDto.getEmail());
        customer.setAccount(postCustomerJoinDto.getAccount());
